...
class Board:
    ...
    colours: colour dictionary --> dict
    """

    def __init__(self, v_cells: int, h_cells: int, origin_x: int, origin_y: int,
                 cell_size: int, screen: int, colours: dict):
        ...
        for i in range(self.v_cells):
            ...
            for j in range(self.h_cells):
                ...
                if (i, j) == self.start:
                    ...
                    colour = self.colours["frontier"]
                elif (i, j) in self.wall:
                    colour = self.colours["gray"]
                elif (i, j) in self.path:
                    colour = self.colours["p_yellow"]
                else:
